...
export const SavingProgressPage: React.FC = () => {
  return (
    <div
      ...
      aria-live="polite"
      aria-busy="true">
      <div className="w-16 h-16 border-4 border-dashed animate-spin-square border-cyan-500"></div>
      <h2 className="text-2xl font-bold text-white mt-8 uppercase tracking-widest">
        Creating your remix...
      </h2>
